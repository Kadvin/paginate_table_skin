...
module PaginateTableSkin
  ...
  @@default_actions[:new]     = {:label => I18n.t("activerecord.actions.new"),
    :url=>"%s/new", :image=>"/images/paginate/new.png",
    :onclick => "Paginate.Button.activateNew(this)"
  }
  @@default_actions[:edit]    = {:label => I18n.t("activerecord.actions.edit"),
  ...
  @@default_actions[:delete]  = {:label => I18n.t("activerecord.actions.delete"),
  ...
  @@default_actions[:refresh] = {:label => I18n.t("activerecord.actions.refresh"),
